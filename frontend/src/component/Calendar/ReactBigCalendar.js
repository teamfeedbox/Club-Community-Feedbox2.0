...
export default function ReactBigCalendar() {
  ...
  const addEvent = async (e) => {
    ...
    result = await result.json();
    console.log(result);
    setTitle(""); setScope(""); setEventDate(""); setEventTime(""); setVenue(""); setDesc(""); setSpeaker("");
  ...
  const handleEvent = (val) => {
    ...
    var currEventDate = start.getDate() < 10 ? "0" + start.getDate() : start.getDate();
    var month = (parseInt(start.getMonth()) + 1) < 10 ? "0" + (parseInt(start.getMonth()) + 1) : parseInt(start.getMonth()) + 1;
    ...
    <>
      ...
      <div className="Calendar-container">
        <div className="Calendar-left">
          ...
          <div className="Calendar-add" onClick={() => { setAddEventModel(true) }}>
            <div>
              Create Event
              <FontAwesomeIcon
          ...
          <div className="Calendar-view">
            {
              preEventModel ?
                <div className="Calendar-view-title" style={{ borderRadius: "30px 30px 0px 0px" }}>
                  Events Preview
                </div>
                :
                <div className="Calendar-view-title" style={{ borderRadius: "30px" }}>Events Preview</div>
            }
          </div>
            ...
            <div className="Calendar-view-events-container">
              <div className={eventPre}>
                <div className="event-pre-handle">
                  ...
                  <div className="cancel-view-event" onClick={() => { setPreEventModel(false) }}>
                ...
                <div className="preview-button">
                  ...
                  {interestedBtn ?
                    <button type="button" onClick={() => { attendanceUpdate(myEvent._id); setInterestedBtn(false); }}>
                      Interested
                    </button>
                    :
                    <button type="button" style={{ pointerEvents: "none", backgroundColor: "gray" }}>
                      Interested
                    </button>
                  }
              ...
              <div className="Calendar-add-drop">
                <form onSubmit={addEvent}>
                  <div className="calender-add-title">
                    ...
                    <div className="cancel-button" onClick={() => { setAddEventModel(false) }}>
                      <FontAwesomeIcon icon={faXmark} />
                    </div>
                  </div>
                  <div className="Calendar-title">
                    <span>Title</span>
                    <input type="text" required placeholder="Add Event Title" value={title}
                      maxlength="50" onChange={(e) => setTitle(e.target.value)} />
                  </div>
                  <div style={{ border: "1.5px solid black", padding: "10px 10px 15px 10px", borderRadius: "10px", }}>
                    ...
                    <div className="input-container">
                      ...
                      <select name="type" onChange={(e) => setScope(e.target.value)}>
                        <option selected disabled hidden>Select Community</option>
